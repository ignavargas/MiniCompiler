...
class ListaSimbolos {
    ...
    public:
        ...
        void setTipoContexto(string tc) {
            tipoContexto = tc;
        }

        string getTipoContexto() {
            return tipoContexto;
        }
        ...
        // metodo para encontrar un parametro dentro de la pila por medio de un indice
        string typeAt(int pos){
          int count = 0;
          list<Simbolo*>::iterator it = ls->begin();
          while(it != ls->end() && count != pos){
